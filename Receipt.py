...
class Receipt:
    ...
    def print_rcp_body(self):
        if not self.receipt["lines"]:
            ...
            for line in self.receipt["lines"]:
                print(self.product_line_str(line))

        self.print_rcp_total()

    # ---------- Printing the receipt ----------
    def print_rcp(self):
        print(self.print_rcp_header())

        self.print_rcp_body()

        print(self.print_rcp_total())


    # ---------- Main logic ----------
    def new_receipt(self):
        self.print_rcp_header() #header added
...
class Receipts:
    ...
    def save_receipt(self, receipt):
        ...
        self.receipts[receipt.receipt_no] = receipt.receipt
